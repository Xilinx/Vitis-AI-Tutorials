...
mv  ./compile/fmnist/LeNet/dpu*.elf ./target_zcu104/fmnist/LeNet/model/
...
mv  ./compile/fmnist/miniVggNet/dpu*.elf ./target_zcu104/fmnist/miniVggNet/model/
...
mv  ./compile/fmnist/miniGoogleNet/dpu*.elf ./target_zcu104/fmnist/miniGoogleNet/model/
...
mv  ./compile/fmnist/miniResNet/dpu*.elf ./target_zcu104/fmnist/miniResNet/model/
