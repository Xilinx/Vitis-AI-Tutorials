...
export TUTORIAL=MPSOCDPU-PRE-POST-PL-ACC

#export WRK_DIR=/media/danieleb/DATA/${RELEASE}/Vitis-Tutorials-${RELEASE}/Developer_Contributed
export WRK_DIR=/media/danieleb/DATA/VAI3.0/Vitis-AI-master/tutorials

# for Vitis AI
export VITIS_AI_PATH=${WRK_DIR}/..

# for the HLS kernels and host applications
export MPSOCDPU_PRE_POST_PL_ACC=${WRK_DIR}/${TUTORIAL}/files

# for the necessary included files and libraries of host_apps
export TRD_HOME=${WRK_DIR}/${TUTORIAL}/files/dpu_trd
...
# (there is indeed some redundancy)
# ========================================================
export XLNX_ZYNQMP=${COMMON_IMAGE_ZYNQMP}
export PLATFORM=${VITIS_PLATFORM_XPFM}
# variable of the DPU-TRD
export SDX_PLATFORM=${VITIS_PLATFORM_XPFM}
export EDGE_COMMON_SW=${COMMON_IMAGE_ZYNQMP}
...
echo "EDGE_COMMON_SW       "  ${COMMON_IMAGE_ZYNQMP}
echo "KERNEL_IMAGE         "  ${KERNEL_IMAGE}
echo "ROOTFS               "  ${ROOTFS}
echo "VITIS_PLATFORM_XPFM  "  ${VITIS_PLATFORM_XPFM}
echo "SDX_PLATFORM         "  ${VITIS_PLATFORM_XPFM}
