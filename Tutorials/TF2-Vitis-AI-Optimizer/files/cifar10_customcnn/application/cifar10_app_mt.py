...
def app(image_dir,threads,model):
    ...
    for i in range(len(out_q)):
        ...
        #print("listimage[", i, "] ", tmp_ground_truth)
...
def main():
  ...
  ap.add_argument('-d', '--image_dir', type=str, default='test', help='Path to folder of images. Default is images')
  ap.add_argument('-t', '--threads',   type=int, default=1,        help='Number of threads. Default is 1')
  ap.add_argument('-m', '--model',     type=str, default='minicnn.xmodel', help='Path of xmodel. Default is minicnn.xmodel')
