...
from tensorflow.keras.layers import GlobalAveragePooling2D,BatchNormalization,ReLU
...
def mobilenetv2(input_shape=(None,None,None),classes=None,alpha=1.0):
  '''
  MobileNetV2
  Arguments:
...
def build_mobilenetv2(weights=None,input_shape=(None,None,None),classes=2,alpha=1.0):
  '''
  build model and load weights if required
  '''

  model = mobilenetv2(input_shape=input_shape,classes=classes,alpha=alpha)
