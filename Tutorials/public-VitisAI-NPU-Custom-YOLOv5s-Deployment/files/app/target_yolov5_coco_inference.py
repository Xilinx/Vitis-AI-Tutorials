...
# Usage:
#  python3 target_yolov5_coco_inference.py --images_dir yolov5/datasets/coco/images/val2017 --json host_coco_10images_detections.json --NbImages 10
#  python3 target_yolov5_coco_inference.py --images_dir files/app/images                    --json host_zidane_bus_coco_detections.json --NbImages 4
...
def main_inf(inp_snapshot_dir, inp_images_dir, inp_detections_file,  NbImages, dump_output) :
    ...
    for index, image_file in enumerate(image_files, start=1) :
        ...
        out_array = np.array(out_list)  # This combines them into a single array
...
def main():
    ...
    parser.add_argument("--snapshot", type=str, 
                            default=os.path.join(WRK_DIR,"snapshots/snapshot.bs1.coco_100Q_yolov5s"), 
                            help="Path to the snapshot folder")    
    parser.add_argument("--images_dir", type=str,
                            default=os.path.join(WRK_DIR,"demo/yolov5/datasets/coco/images/val2017"), 
                            help='Path to the input images folder')
    parser.add_argument("--json", type=str,
                            default=os.path.join(WRK_DIR,"coco_snap100Q_5000images_detections_conf025_iou045.json"),
