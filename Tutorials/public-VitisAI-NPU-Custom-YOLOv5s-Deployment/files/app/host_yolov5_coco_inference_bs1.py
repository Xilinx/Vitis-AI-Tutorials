...
# It currently supports processing a single batch (BS=1).
...
def main_inf(inp_images_dir, inp_detections_file, NbImages, dump_output) :
    dump_input  = False
    ...
    for index, image_file in enumerate(image_files, start=1) :
        ...
        for idx, tensor in enumerate(results):
            ...
            X1Y1X2Y2_detections = detect_and_annotate(tensor, image_path, original_size,
...
def main():
    ...
    # run main inference
    main_inf(args.images_dir, args.json, args.NbImages, args.dump_out)
