...
def make_parser():
    ...
    parser.add_argument('--colors', type=str, required=True, help='label colors')
...
if __name__ == '__main__':
    ...
    label_colors = cv2.imread(args.colors, 1).astype(np.uint8)
    ...
    if args.out_dir is not None:
        ...
        out_path_im = args.out_dir + input_image_name + 'ESPNet_encoder' + '.' + input_path_ext
        out_path_gt = args.out_dir + input_image_name + 'ESPNet_gt' + '.' + input_path_ext
