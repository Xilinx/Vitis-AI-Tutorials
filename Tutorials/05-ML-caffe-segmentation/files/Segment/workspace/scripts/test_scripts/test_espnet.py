...
if __name__ == '__main__':
    ...
    output_shape = net.blobs['ConvNd_85'].data.shape
    ...
    prediction = net.blobs['ConvNd_85'].data[0].argmax(axis=0)
    ...
    if args.out_dir is not None:
        ...
        out_path_im = args.out_dir + input_image_name + 'ESPNet' + '.' + input_path_ext
