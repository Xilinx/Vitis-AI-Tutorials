...
if [ $1 = zcu102 ]; then
      ...
      TARGET=vck5000
      echo "-----------------------------------------"
      echo "COMPILING MODEL FOR VERSAL VCK5000.."
      echo "-----------------------------------------"
else
      echo  "Target not found. Valid choices are: zcu102, zcu104, u50, vck190, vck5000 ..exiting"
      exit 1
fi
...
mkdir -p build/compiled_model_${TARGET}
