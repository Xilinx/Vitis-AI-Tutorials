...
class Configs():
    def __init__(self):
        ...
        parser.add_argument('--data-folder', type=str, default='./data',help='training dataset folder (default: ./data)')
        ...
        parser.add_argument('--batch-size', type=int, default=5,metavar='N', help='input batch size for testing (default: 10)')
