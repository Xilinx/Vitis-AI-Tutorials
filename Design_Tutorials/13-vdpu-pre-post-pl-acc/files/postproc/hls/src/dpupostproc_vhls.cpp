...
//#include "lut_exp.h" //just the LUT for the scaling factor of ZF's CNN
...
{
	//create a function that reads the 256 floating point values of the Look Up Table generated by the ARM CPU
