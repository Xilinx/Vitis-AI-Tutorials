...
{
#pragma HLS INTERFACE axis register_mode=both register depth=PRE_hls_IMGSZ_V port=inp_img
#pragma HLS INTERFACE axis register_mode=both register depth=PRE_hls_IMGSZ_V port=img_out
