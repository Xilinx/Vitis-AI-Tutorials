...
def synth_input_fn(is_training, batch_size, height=100, width=100,
        num_channels=3, num_classes=131, dtype=tf.float32):
...
def get_filenames(is_training, data_dir):
  ...
  if is_training:
    ...
    return [
        os.path.join(data_dir, 'validation-%05d-of-00002' % i)
        for i in range(2)]
