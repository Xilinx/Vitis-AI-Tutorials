...
#define PRE_MAX_HEIGHT    224  //((1080+8)/2)  // number of lines per image
#define PRE_MAX_WIDTH     224  //(1920/2)      // number of pixels per line
...
const int PRE_hls_trip_count_loop = PRE_hls_IMGSZ_V;   //for HLS pragmas LOOP TRIPCOUNT
...
/* ******************************************************************************* */
// I/O Image Settings
#define PRE_INPUT_IMAGE		"./data_pre/inp_000"
