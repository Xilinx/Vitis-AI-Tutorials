...
_R_MEAN = 123 #124.45967  #123.17545
_G_MEAN = 114 #116.04212  #114.27699
_B_MEAN = 104 #106.40268  #104.16305

MEANS = np.asarray([_B_MEAN,_G_MEAN,_R_MEAN], dtype=np.float32)
...
def runDPU(id,start,dpu:"Runner",img):
    ...
    while count < n_of_images:
        ...
        #print(np.asarray(inputData).shape)
        #print(np.asarray(outputData).shape)
...
def main():
  ...
  ap.add_argument('-m', '--model',   type=str,                           help='Path of xmodel file')
