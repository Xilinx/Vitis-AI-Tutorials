...
echo "Compiling network: ${CNN} for ZCU102"
...
cp ${output_dir}/${CNN}.xmodel  ${output_dir}/../../zcu102/baseline/model/arm64_4096/
...
cp ${output_dir}/${CNN}.xmodel  ${output_dir}/../../vck190/baseline/model/arm64_4096/
